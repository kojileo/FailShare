  ...
  const steps = [
    {
      ...
      description: '失敗を成長の糧に変える安全なコミュニティです。\n\n完全匿名で失敗体験を共有し、同じ経験をした人同士で学び合えます。\n\n現在は「エンジニア関連」と「恋愛関連」の二大コンテンツを中心に、質の高い失敗談を集めています。',
      buttonText: '始める'
    },
    {
      icon: '📝',
    ...
    },
    {
      icon: '🔍',
      title: '二大コンテンツから学ぼう',
      description: 'カテゴリーや感情で失敗談を検索できます：\n\n• エンジニア関連：開発・転職・技術習得の失敗\n• 恋愛関連：デート・告白・人間関係の失敗\n• 感情タグで検索（後悔、恥ずかしい、不安など）\n• キーワード検索で具体的な事例を発見\n\n同じような経験をした人の知恵を活用できます。',
      buttonText: '次へ'
    },
    {
      icon: '🤝',
